...
import { addToCartAction, removeFromCart } from '../redux/action/cartAction'
      ...
      (x) => (
        <option key={x+1} value={x+1}>
          {x+1}
                ...
                <div className="flex">
                  <button type="button" className="font-medium text-indigo-600 hover:text-indigo-500" onClick={()=> removeItemFromCart(product.product)}>
                    Remove
                  </button>
                </div>
              </div>
