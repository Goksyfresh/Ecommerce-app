...
const Detail = () => {
  ...
  return (
    <>
 {loading ? (<Spinner/>) : error ? (<h1>{error}</h1>) : product ? (
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="flex">
                ...
                {product.countInStock > 0 ? (
                  ...
                  <>
                   <h1 className="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">Out of Stock</h1>
                  </>
                )}
